        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {CERTIFICATIONS_DATA.map((item: Certification, index: number) => (
            <motion.div
              ...
              className="bg-[var(--bg-card)] rounded-2xl p-6 sm:p-8 border border-white/10 hover:border-[var(--accent-teal)] shadow-xl shadow-black/30 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between group"
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  <div className="w-12 h-12 rounded-2xl bg-[var(--bg-badge-pill)] border border-white/10 flex items-center justify-center text-[var(--accent-teal)] group-hover:scale-110 transition-transform">
                    {index === 0 ? <GraduationCap className="w-6 h-6" /> : <Award className="w-6 h-6" />}
                  </div>

                  <span className="px-3 py-1 rounded-full bg-[var(--bg-badge-pill)] text-[var(--accent-teal-hover)] text-xs font-mono font-semibold border border-white/10">
                    {item.badgeText}
                  </span>
                </div>
                ...
                <p className="text-sm font-medium text-[var(--text-heading-muted)] mb-4">
                  {item.institution}
                </p>
              </div>
              ...
              <div className="pt-4 border-t border-white/5 flex items-center justify-between text-xs text-[var(--text-muted)]">
                ...
                <span className="inline-flex items-center gap-1 hover:text-[var(--text-heading-light)] transition-colors cursor-pointer">
                  <span>Verify</span>
